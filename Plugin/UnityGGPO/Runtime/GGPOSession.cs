...
namespace UnityGGPO {
    ...
    public static partial class GGPO {
        ...
        public static class Session {
            ...
            public static int TestStartSession(
                    BeginGameDelegate beginGame,
                    AdvanceFrameDelegate advanceFrame,
                    SafeLoadGameStateDelegate loadGameState,
                    SafeLogGameStateDelegate logGameState,
                ...
                var result = GGPO.TestStartSession(out ggpo,
                    _beginGameCallback,
                    _advanceFrameCallback,
                    _loadGameStateCallback,
                    _logGameStateCallback,
            ...
            public static int AddPlayer(GGPOPlayer player, ref BackrollPlayerHandle phandle) {
			...
			[MonoPInvokeCallback(typeof(FreeBufferDelegate))]
			...
			[MonoPInvokeCallback(typeof(SaveGameStateDelegate))]
			...
			[MonoPInvokeCallback(typeof(LogGameStateDelegate))]
